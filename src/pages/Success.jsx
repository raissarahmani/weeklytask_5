...
function Success() {
  return (
    <div className='relative flex flex-row bg-[#DEDEDE]'>
      <section className='relative w-3/5 bg-cover z-0 py-[20vh] pr-[5vw] pl-[10vw] before:content-[""] before:absolute before:inset-0 before:-z-1 before:bg-[#00000099]' style={{backgroundImage: `url(${Bg})`}}>
          <div>
