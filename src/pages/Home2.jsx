...
function Home2() {
  return (
    <>
    <section className='bg-[50%_50%] relative z-0 before:content-[""] before:absolute before:inset-0 before:-z-1 before:bg-[#00000099]' style={{backgroundImage: `url(${Background})`}}>
