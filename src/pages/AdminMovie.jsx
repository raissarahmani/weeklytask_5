    ...
    <section className='bg-[#fff] rounded-3xl py-[7vh] px-[5vw]'>
        <div className='flex flex-row justify-between'>
            ...
            <div className='flex flex-row gap-[1vw]'>
                ...
                <button className='custom-button bg-[#1D4ED8] text-[#fff] text-sm w-1/2'>Add Movie</button>
            </div>
        </div>
        <div>
            <table className='w-full border-collapse my-[5vh]'>
                <tr className='border-b border-[#E6EAF0] text-center'>
                    ...
                    <th className='text-[#1F4173] text-xs font-semibold py-[2vh]'>Movie Name</th>
                    <th className='text-[#1F4173] text-xs font-semibold py-[2vh]'>Category</th>
                    <th className='text-[#1F4173] text-xs font-semibold py-[2vh]'>Released Date</th>
                    <th className='text-[#1F4173] text-xs font-semibold py-[2vh]'>Duration</th>
                    <th className='text-[#1F4173] text-xs font-semibold py-[2vh]'>Action</th>
                </tr>
                <tr className='border-b border-[#E6EAF0] text-center'>
                    ...
                    <td className='text-[#1D4ED8] text-sm'>Spiderman Homecoming</td>
                    <td className='text-[#1F4173] text-sm'>Action, Adventure</td>
                    <td className='text-[#1F4173] text-sm'>07/05/2023</td>
                    <td className='text-[#1F4173] text-sm'>2 Hours 15 Minutes</td>
                    <td className='flex flex-row justify-evenly items-center py-[3vh]'>
                ...
                <tr className='border-b border-[#E6EAF0] text-center'>
                    ...
                    <td className='text-[#1D4ED8] text-sm'>Avengers End Game</td>
                    <td className='text-[#1F4173] text-sm'>Sci-fi, Adventure</td>
